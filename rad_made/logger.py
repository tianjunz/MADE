...
AGENT_TRAIN_FORMAT = {
    "made": [
        ...
        ("critic_entropy_max", "SENT_MX", "float"),
        ("critic_entropy_min", "SENT_MN", "float"),
        ("critic_norm_entropy", "NSENT", "float"),
        ("critic_norm_entropy_max", "NSENT_MX", "float"),
        ("critic_norm_entropy_min", "NSENT_MN", "float"),
    ],
}
...
class Logger(object):
    def __init__(
        self, log_dir, save_tb=False, log_frequency=10000, action_repeat=1, agent="made"
    ):
