...
class ReplayBuffer(object):
    ...
    def __init__(
        ...
        if random_encoder is not None:
            ...
            self.random_encoder = None
            self.s_ent_stats = None
    ...
    def sample(self, batch_size, magnitude=None):
        ...
        if self.random_encoder is not None:
            ...
            tgt_random_feats = None
            src_random_feats = None
    ...
    def sample_last(self, batch_size, magnitude=None):
        if self.idx > batch_size:
            idxs = np.arange(self.idx-batch_size, self.idx)
        else:
            idxs = np.concatenate([np.arange(self.idx), np.arange(self.capacity-batch_size+self.idx, self.capacity)])
